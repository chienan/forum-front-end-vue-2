  ...
  methods: {
    ...
    fetchUsers(userId) {
      this.user = {
        ...
        isAdmin: dummyData.user.isAdmin,
        image: dummyData.user.image,
        comments: dummyData.user.Comments,
        favoritedRestaurants: dummyData.user.FavoritedRestaurants,
        followers: dummyData.user.Followers,
        followings: dummyData.user.Followings
      };
